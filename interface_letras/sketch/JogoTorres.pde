...
class JogoTorres {
  ...
  void drawTitle() {
    ...
    parent.textSize(44);
    parent.fill(0);
    parent.text("Jogo das Torres", parent.width/2, 60);
  }
  ...
  void drawInstruction() {
    ...
    parent.textSize(24);
    parent.text("Coloca as torres na ordem correta", parent.width/2, 120);
  }
  ...
  void drawTowerCard() {
    ...
    parent.textSize(20);
    parent.fill(70);
    parent.text("Depois pressiona o botão", 0, 70);
    parent.popMatrix();
  ...
  void drawTagInfo() {
    ...
    parent.textSize(18);
    parent.fill(40);
    parent.text("Última tag: " + (hasLine ? currentLine : "nenhuma"), parent.width/2, 590);
  }
